...
const TELEGRAM_COMMAND_ENTRIES: LocalizedTelegramCommandEntry[] = [
  { command: "help", aliases: ["start"], handler: "sendHelp", description: { zh: "查看完整帮助", en: "Show full help" }, helpLines: [{ zh: "/help 查看完整帮助", en: "/help Show full help" }], panel: { group: "help_status", selectable: true, shortLabel: { zh: "Help", en: "Help" } } },
  { command: "commands", handler: "handleCommands", description: { zh: "Open Commands", en: "Open the command panel" }, helpLines: [{ zh: "/commands 打开快捷指令卡；/commands edit 编辑快捷指令", en: "/commands Open the command panel; /commands edit edits quick commands" }] },
  { command: "status", handler: "sendStatus", description: { zh: "查看服务状态", en: "Show bridge status" }, helpLines: [{ zh: "/status 查看服务状态", en: "/status Show bridge status" }], panel: { group: "help_status", selectable: true, shortLabel: { zh: "Status", en: "Status" } } },
  { command: "hub", handler: "handleHub", description: { zh: "重新查看运行卡片", en: "Bring back the runtime hub" }, helpLines: [{ zh: "/hub 重新查看运行卡片", en: "/hub Bring back the runtime hub" }], panel: { group: "help_status", selectable: true, shortLabel: { zh: "Hub", en: "Hub" } } },
  { command: "new", handler: "handleNew", description: { zh: "选择项目并新建会话", en: "Choose a project and create a session" }, helpLines: [{ zh: "/new 选择项目并新建会话", en: "/new Choose a project and create a session" }], panel: { group: "session_project", selectable: true, shortLabel: { zh: "New", en: "New" } } },
  { command: "resume", handler: "handleResume", description: { zh: "恢复 Codex 历史会话", en: "Resume a Codex history thread" }, helpLines: [{ zh: "/resume 查看可恢复的 Codex 会话；/resume <序号> 恢复", en: "/resume Show resumable Codex threads; /resume <index> resumes one" }], panel: { group: "session_project", selectable: true, shortLabel: { zh: "Resume", en: "Resume" } } },
  { command: "browse", handler: "handleBrowse", description: { zh: "浏览当前项目文件", en: "Browse the current project files" }, helpLines: [{ zh: "/browse 浏览当前项目文件", en: "/browse Browse the current project files" }], panel: { group: "session_project", selectable: true, shortLabel: { zh: "Browse", en: "Browse" } } },
  { command: "sessions", handler: "handleSessions", description: { zh: "查看最近会话", en: "Show recent sessions" }, helpLines: [{ zh: "/sessions 查看最近会话", en: "/sessions Show recent sessions" }, { zh: "/sessions archived 查看已归档会话", en: "/sessions archived Show archived sessions" }], panel: { group: "session_project", selectable: true, shortLabel: { zh: "Session", en: "Sessions" } } },
  { command: "archive", handler: "handleArchive", description: { zh: "归档当前会话", en: "Archive the current session" }, helpLines: [{ zh: "/archive 归档当前会话", en: "/archive Archive the current session" }, { zh: "/archive all 归档所有非运行中会话", en: "/archive all Archive every non-running session" }], panel: { group: "session_project", selectable: true, shortLabel: { zh: "Archive", en: "Archive" } } },
  ...
  { command: "model", handler: "handleModel", description: { zh: "查看或设置当前会话模型", en: "Show or set the session model" }, helpLines: [{ zh: "/model 查看或设置当前会话模型", en: "/model Show or set the session model" }], panel: { group: "codex", selectable: true, shortLabel: { zh: "Model", en: "Model" } } },
  { command: "skills", handler: "handleSkills", description: { zh: "列出当前项目可用技能", en: "List project skills" }, helpLines: [{ zh: "/skills 查看当前项目可用技能", en: "/skills List project skills" }], panel: { group: "codex", selectable: true, shortLabel: { zh: "Skills", en: "Skills" } } },
  ...
  { command: "plugins", handler: "handlePlugins", description: { zh: "列出当前项目可用插件", en: "List available plugins" }, helpLines: [{ zh: "/plugins 查看当前项目可用插件", en: "/plugins List available plugins" }], panel: { group: "codex", selectable: true, shortLabel: { zh: "Plugins", en: "Plugins" } } },
  ...
  { command: "account", handler: "handleAccount", description: { zh: "查看当前 Codex 账号状态", en: "Show the Codex account state" }, helpLines: [{ zh: "/account 查看当前 Codex 账号与额度", en: "/account Show the Codex account and usage status" }], panel: { group: "codex", selectable: true, shortLabel: { zh: "Account", en: "Account" } } },
  { command: "review", handler: "handleReview", description: { zh: "启动当前会话的代码审查", en: "Start a review for the current session" }, helpLines: [{ zh: "/review [detached] [branch <分支>|commit <SHA>|custom <说明>] 启动审查", en: "/review [detached] [branch <branch>|commit <SHA>|custom <desc>] Start a review" }], panel: { group: "codex", selectable: true, shortLabel: { zh: "Review", en: "Review" } } },
  { command: "fork", handler: "handleFork", description: { zh: "分叉当前会话线程", en: "Fork the current session thread" }, helpLines: [{ zh: "/fork [名称] 分叉当前线程为新会话", en: "/fork [name] Fork the current thread into a new session" }], panel: { group: "codex", selectable: true, shortLabel: { zh: "Fork", en: "Fork" } } },
  { command: "rollback", handler: "handleRollback", description: { zh: "选择目标并回滚线程", en: "Pick a rollback target" }, helpLines: [{ zh: "/rollback 选择回滚目标；/rollback <数量> 兼容旧用法", en: "/rollback Pick a rollback target; /rollback <count> keeps the legacy form" }], panel: { group: "codex", selectable: true, shortLabel: { zh: "Rollback", en: "Rollback" } } },
  { command: "compact", handler: "handleCompact", description: { zh: "压缩当前线程上下文", en: "Compact the current thread context" }, helpLines: [{ zh: "/compact 压缩当前线程上下文", en: "/compact Compact the current thread context" }], panel: { group: "codex", selectable: true, shortLabel: { zh: "Compress", en: "Compact" } } },
  ...
  { command: "where", handler: "sendWhere", description: { zh: "查看当前会话、项目和定位 ID", en: "Show current session and IDs" }, helpLines: [{ zh: "/where 查看当前会话、项目和定位 ID", en: "/where Show the current session, project, and IDs" }], panel: { group: "help_status", selectable: true, shortLabel: { zh: "Where", en: "Where" } } },
  { command: "inspect", handler: "handleInspect", description: { zh: "查看当前任务详情", en: "Inspect the current task" }, helpLines: [{ zh: "/inspect 查看当前任务详情", en: "/inspect Inspect the current task" }], panel: { group: "help_status", selectable: true, shortLabel: { zh: "Details", en: "Inspect" } } },
  ...
  { command: "language", handler: "handleLanguage", description: { zh: "切换桥接界面语言", en: "Change bridge UI language" }, helpLines: [{ zh: "/language 切换桥接界面语言", en: "/language Change bridge UI language" }], panel: { group: "help_status", selectable: true, shortLabel: { zh: "Language", en: "Language" } } },
  { command: "interrupt", handler: "handleInterrupt", description: { zh: "停止当前正在执行的操作", en: "Interrupt the current operation" }, helpLines: [{ zh: "/interrupt 停止当前正在执行的操作", en: "/interrupt Interrupt the current operation" }], panel: { group: "control", selectable: true, shortLabel: { zh: "Interrupt", en: "Interrupt" } } },
...
export function getTelegramCommandPanelGroups(language: UiLanguage): TelegramCommandPanelGroupView[] {
  const labels: Record<TelegramCommandPanelGroup, string> = {
    help_status: language === "en" ? "Help & Status" : "Help & Status",
    session_project: language === "en" ? "Sessions & Projects" : "Sessions & Projects",
    codex: language === "en" ? "Codex" : "Codex",
    control: language === "en" ? "Control" : "Control"
  };
